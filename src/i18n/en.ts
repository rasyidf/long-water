...
export const en: Record<string, string> = {
  ...
  "trick.scrape": "Barnacle Scrape",
  "trick.drafting": "Drafting",
  "trick.breachEvasion": "Breach Evasion",
  "trick.perfectApex": "Perfect Apex",
  "trick.tailSlap": "Tail Slap",
  "milestone.distance": "{km} km down",
  "milestone.depth.twilight": "Into the twilight",
  "milestone.depth.dark": "Into the dark",
  "milestone.depth.deep": "The deep water",
  "milestone.depth.abyssal": "The abyss",
  "milestone.depth.trench": "The ocean floor",
  "milestone.pod.1": "The pod begins",
  "milestone.pod.3": "A travelling pod",
  "milestone.pod.6": "A full chorus line",
  "milestone.pod.12": "A grand pod",
  "milestone.pod.25": "A super-pod",
  ...
  "almanac.manta-giant.name": "Giant Manta",
  "almanac.manta-giant.size": "up to 7 m across",
  "almanac.manta-giant.found": "Open water, near the surface",
  "almanac.manta-giant.temper": "Serene — a rare, majestic sight",
  "almanac.manta-giant.body":
    "An enormous ray that seems to fly rather than swim, its wide wings " +
    "barely stirring the water as it passes.",

  "almanac.parrotfish-green.name": "Green Parrotfish",
  "almanac.parrotfish-green.size": "deep-bodied, stout",
  "almanac.parrotfish-green.found": "Shallow reef, grazing coral",
  "almanac.parrotfish-green.temper": "Unbothered, busy grazing",
  "almanac.parrotfish-green.body":
    "A stocky reef grazer with a fused beak-like mouth, rasping algae off " +
    "the coral it lives among.",

  "almanac.abyssal-lantern.name": "Abyssal Lanternfish",
  "almanac.abyssal-lantern.size": "small, barely visible",
  "almanac.abyssal-lantern.found": "The deep water, far past the light",
  "almanac.abyssal-lantern.temper": "Wary, quick to douse its glow",
  "almanac.abyssal-lantern.body":
    "A small deep-water fish carrying its own light — a single bioluminescent " +
    "lure in the permanent dark.",

  "almanac.vampire-squid.name": "Vampire Squid",
  "almanac.vampire-squid.size": "small, umbrella-shaped",
  "almanac.vampire-squid.found": "The deep water, drifting slowly",
  "almanac.vampire-squid.temper": "Passive — no relation to the hunter above",
  "almanac.vampire-squid.body":
    "A slow, deep-water drifter despite the name — it has no interest in " +
    "the whale at all.",
  ...
  "trophy.tail-slapper.name": "Tail Slapper",
  "trophy.tail-slapper.desc": "Come down flat and fast, tail-first.",
  "trophy.parasite-cleansed.name": "Parasite Cleansed",
  "trophy.parasite-cleansed.desc": "Scrape along the seabed at speed.",
  "trophy.pod-begins.name": "The Pod Begins",
  "trophy.pod-begins.desc": "Have your first whale fall in behind you.",
  "trophy.growing-pod.name": "Growing Pod",
  "trophy.growing-pod.desc": "Travel with three whales behind you.",
  "trophy.twilight-zone.name": "The Twilight Zone",
  "trophy.twilight-zone.desc":
    "Pass 80 m down, where the light starts to fade.",
  ...
  "trophy.perfect-apex.name": "Perfect Apex",
  "trophy.perfect-apex.desc": "Stall at the exact top of a breach.",
  "trophy.chorus.name": "Chorus",
  "trophy.chorus.desc": "Sing together with your pod.",
  "trophy.slipstream-rider.name": "Slipstream Rider",
  "trophy.slipstream-rider.desc": "Hold station inside a crowd of your escort.",
  ...
  "trophy.flow-master.name": "In the Flow",
  "trophy.flow-master.desc": "Reach the top of the trick flow multiplier.",
  "trophy.grand-pod.name": "Grand Pod",
  "trophy.grand-pod.desc": "Travel with twelve whales behind you.",
  "trophy.abyssal-voyager.name": "Abyssal Voyager",
  "trophy.abyssal-voyager.desc": "Pass 700 m down.",
  "trophy.triple.name": "Triple Backflip",
  "trophy.triple.desc": "Land three full turns in one breach.",
  "trophy.kinetic-release.name": "Kinetic Release",
  "trophy.kinetic-release.desc":
    "Shake a latched squid loose with a hard breach.",
  ...
  "trophy.super-pod.name": "Super-Pod",
  "trophy.super-pod.desc": "Travel with twenty-five whales behind you.",
  "trophy.hadal-descent.name": "Hadal Descent",
  "trophy.hadal-descent.desc": "Reach the ocean floor, 1,100 m down.",
